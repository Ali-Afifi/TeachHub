...
namespace online_course_platform.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            List<UserViewModel> users = (List<UserViewModel>)await _userService.GetAll();
        ...
        // public async Task<IActionResult> Create([Bind("Id,UserName,FirstName,LastName,Gender,BirthDate,PasswordHash,PasswordHashSalt,UpdateBy,IpAddressOfLastUpdate,UpdatedAt,LastUpdateOperation")] User user)
        // {
